...
var Configurations = [
        [ //Board 00
            ...
            ,'{"id":34, "type":"R","Pin":34,"lhOn":1,"status":0,"priority":20}'	//L1.7 Крыльцо наружный
	        ,'{"id":35, "type":"R","Pin":35,"lhOn":1,"status":0,"priority":10}'   //L2.7
            ,'{"id":36, "type":"R","Pin":36,"lhOn":1,"status":0,"priority":10}'	//L1.8
...
// Крыльцо
         ,'{"id":90,"originId":5,"originType":"B","event":1,"targetId":34,"targetAction":3,"targetType":"R"}'
